...
var schemaUri =
  'https://jenkins.ivyteam.io/job/core_json-schema/job/XIVY-15692-RuntimeLogLspSchema/21/artifact/workspace/ch.ivyteam.ivy.runtime.log.lsp.schema/target/schema/log/13.1.0/log-tsgen.json';
